...
export default function Hero(){
    ...
    const roles = ['Software Engineering.','Front-End Development.', 'Full-Stack Development.'];
    ...
    return(
        <div className="hero-content">
            ...
            <div className='intro'>
                ...
                <p className='currently-seeking'>Currently seeking a role in<br/>
           ...
           <div>
            ...
            <div className='link-group'>
                ...
                <a href="https://linkedin.com/in/joann-carter/" target="_blank" rel="noreferrer"> 
